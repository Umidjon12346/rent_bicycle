...
router.get("/:id", authGuard, clientGuard, userSelfGuard(Card), getCardById);
router.delete("/:id", authGuard, clientGuard, userSelfGuard(Card), deleteCard);
router.put("/:id", authGuard, clientGuard, userSelfGuard(Card), updateCard);
